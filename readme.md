...
###The application contains components that are deployed to handle user requests and manage microservice deployment on docker swarm. The instructions to deploy them are captured below:

- Tomcat/Java/Postgres Database Manager
    - Provides internal RESTful APIs to manage postgres database :
```
